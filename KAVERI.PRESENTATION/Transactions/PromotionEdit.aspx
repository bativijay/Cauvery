<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Clinic.master" AutoEventWireup="true"
    CodeFile="PromotionEdit.aspx.cs" Inherits="Transactions_PromotionEdit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="maincontent" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td align="center" colspan="2" class="cpHeader" style="width: 100%; margin-left: 120px;">
                <asp:Label ID="Label23" runat="server" Text="Promotion Edit" Font-Bold="True" 
    ...
    <table width="100%" class="Body">
        ...
        <tr>
            ...
            <td class="style33">
                <asp:DropDownList ID="ddlAcedamic" runat="server" Height="21px" Width="34px"
        ...
        <tr>
            ...
            <td class="style28">
                <asp:DropDownList ID="ddlStandard" runat="server" Height="21px" Width="122px" 
            ...
            <td class="style32">
                <asp:DropDownList ID="ddlTemplate" runat="server" Height="21px" Width="144px" 
                    AutoPostBack="True" Enabled="False">
                </asp:DropDownList>
            </td>
            <td align="center" class="style33">
                Template To Change <span style="color: rgb(255, 0, 0);">&nbsp;*</span>
            </td>
            <td align="center" class="style26">
                <asp:DropDownList ID="ddlNewTemplate" runat="server" Height="21px" 
