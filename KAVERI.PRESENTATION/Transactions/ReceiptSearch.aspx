<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ReceiptSearch.aspx.cs"
    Inherits="Transactions_ReceiptSearch" %>
    ...
    <table width="100%">
        <tr>
            <td align="center" colspan="2" class="cpHeader" style="width: 100%">
                <asp:Label ID="Label23" runat="server" Text="Collection Receipts" Font-Bold="True"
