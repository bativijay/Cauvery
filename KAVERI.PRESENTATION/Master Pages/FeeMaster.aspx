<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Clinic.master" AutoEventWireup="true"
    CodeFile="FeeMaster.aspx.cs" Inherits="MasterPages_FeeMaster" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="maincontent" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td align="center" style="width: 100%" class="cpHeader">
                <asp:Label ID="Label2" runat="server" CssClass="LabelBold" Text="Fee"></asp:Label>
            </td>
        </tr>
    </table>
    <table width="100%">
        <tr>
            <td align="left" class="cpHeader" colspan="2">
                <asp:Label ID="Label3" runat="server" CssClass="LabelBold" Text="Fee Details"></asp:Label>
            </td>
        </tr>
    </table>
    ...
    <table width="100%">
        <tr>
            <td>
                <asp:GridView ID="GvFeeMaster" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    DataKeyNames="FeeId,FeeTypeId,FeeMode" OnPageIndexChanged="GvFeeMaster_PageIndexChanged"
                    OnPageIndexChanging="GvFeeMaster_PageIndexChanging">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="FeeCode" HeaderText="Fee Code" ItemStyle-HorizontalAlign="Left">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="FeeName" HeaderText="Fee Name" ItemStyle-HorizontalAlign="Left">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField DataField="FeeType" HeaderText="Fee Type" ItemStyle-HorizontalAlign="Left">
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
                        </asp:BoundField>
        ...
        <tr>
            <td align="left" class="cpHeader">
                <asp:Label ID="Label1" runat="server" CssClass="LabelBold" Text="Fee Maintenance"></asp:Label>
            </td>
        </tr>
    </table>
    <table width="100%" class="Body">
        <tr>
            <td class="style3">
                Fee Code <span style="color: rgb(255, 0, 0)">*</span>
            </td>
            <td>
                <asp:TextBox ID="txtFeeCode" runat="server" Width="181px" AutoPostBack="True" OnTextChanged="txtFeeCode_TextChanged"
                    CssClass="uppercase"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style3">
                Fee Name <span style="color: rgb(255, 0, 0);">*</span>
            </td>
            <td>
                <asp:TextBox ID="txtFeeName" runat="server" Width="181px" CssClass="uppercase"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style3">
                Fee Type <span style="color: rgb(255, 0, 0);">*</span>
            </td>
            <td>
                <asp:DropDownList ID="ddlFeeType" runat="server" Width="184px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td class="style3">
                Fee Mode <span style="color: rgb(255, 0, 0);">*</span>
            </td>
            <td>
                <asp:DropDownList ID="ddlFeeMode" runat="server" Width="184px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
